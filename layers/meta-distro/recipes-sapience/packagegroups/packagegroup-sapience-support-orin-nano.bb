...
KERNEL_ARGS:${PN} = "mminit_loglevel=4 console=ttyTCU0,115200 fbcon=map:0 nospectre_bhb video=efifb:off console=tty0 nvidia-drm.modeset=1 nvidia-drm.fbdev=1"
